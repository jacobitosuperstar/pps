      ...
      <SheetContent className='flex flex-col'>
        <SheetHeader className='pb-0 text-start'>
          ...
          <SheetDescription id='config-drawer-description'>
            Ajusta la apariencia y el diseño para adaptarlos a tus preferencias.
          </SheetDescription>
        </SheetHeader>
  ...
  return (
    <div>
      ...
      <div id='theme-description' className='sr-only'>
        Elige entre usar el tema del sistema, modo claro u oscuro
      </div>
    </div>
  )
}
  ...
  return (
    <div className='max-md:hidden'>
      ...
      <div id='sidebar-description' className='sr-only'>
        Elige entre barra lateral insertada, flotante o estándar
      </div>
    </div>
  )
}
  ...
  return (
    <div className='max-md:hidden'>
      ...
      <div id='layout-description' className='sr-only'>
        Elige entre diseño expandido, compacto o de pantalla completa
      </div>
    </div>
  )
}
  ...
  return (
    <div>
      ...
      <div id='direction-description' className='sr-only'>
        Elige entre dirección de izquierda a derecha o de derecha a izquierda
      </div>
    </div>
  )
}
